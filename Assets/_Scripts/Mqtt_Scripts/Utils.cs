...
public class Utils
{
    ...
    //        l_oAudioClip = AudioClip.Create("MySound", l_aFloatArray.Length/2, 2, l_oMP3Stream.Frequency, false, false);
    //    else
	...
	public static string TopicHeader {
		get {
			return PlayerPrefs.GetString("TopicHeader", "/" + LocalIPAddress());
		}
		set {
